...
class SSD(object):
    ...
    def __init__(self, weights, model, input_encoder, model_img_size):
        ...
        self.encoded_detections = tf.placeholder(dtype=tf.float32, shape=predictions.shape)
        ...
        self.encoded_labels = tf.placeholder(dtype=tf.float32, shape=predictions.shape)
